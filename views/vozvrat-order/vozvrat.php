  ...
  <div class="col-md-5">
    <div class="panel panel-inverse">
      <div class="panel-heading" style="background-color: #b35555;">
        ...
        <h4 class="panel-title">Vozvrat qilinadigan mahsulotlarni tanlang</h4>
      </div>
        ...
        <div class="table-responsive">
          ...
          <div style="height: 700px; overflow-y: auto; display: block; width: 100%; pointer-events: none;" id="productTableWrapper">
            <table class="table">
              <thead>
                <tr>
                  <th style="background-color:#d4ddd7;"><b>#</b></th>
  ...
  <div class="col-md-7" style="position: sticky; top: 60px;">
    <div class="panel panel-inverse">
      <div class="panel-heading" style="background-color: #b35555;">
        ...
        <h4 class="panel-title">Mijoz vozvrat buyurtmasi</h4>
      </div>
      <div class="panel-body">
        <div class="table-responsive">
          ...
          <table class="table">
            <thead>
            <tr>
              <th style="background-color:#d4ddd7;width: 5%;"><b>#</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 12%;"><b>Joy</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 18%;"><b>Model</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 15%;"><b>Nomi</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 10%;"><b>O'lcham</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 15%;"><b>Tip</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 10%;"><b>Narxi ($)</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 8%;"><b>Soni</b></th>
              <th nowrap style="background-color:#d4ddd7;width: 10%;"><b>Umum.narxi ($)</b></th>
              <th style="background-color:#d4ddd7;"><b></b></th>
            </tr>
            </thead>
          ...
          <button id="sellButton" class="btn btn-sm btn-danger buy_product" style="width:100%" disabled>Vozvrat qilish</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal-dialog2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Vozvrat karzinkasiga qo'shish</h4></div>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger submit">Karzinkaga qo'shish</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal-dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Vozvrat qilish</h4></div>
      <div class="modal-body">
        <form id="buy" action="<?= Url::toRoute(['vozvrat-order/accept'])?>" method="post">
          <div class="form-group row m-b-15 align-items-center">
...
<div class="modal fade" id="modal-dialog-error">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row m-b-15 align-items-center">
          <label class="col-sm-12 col-form-label"><h5><b style="color:red">Mijozda hech qanday vozvrat buyurtma yo'q. </b></h5></label>
        </div>
        <div class="modal-footer">
