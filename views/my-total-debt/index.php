...
$this->title = 'Mening qarzlarim hisobi';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);
$totalDebtSum = MyTotalDebt::find()->sum('total_debt');
?>
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Mening barcha qarzmi: <b style="font-size: 18px;"><?=  Yii::$app->formatter->asDecimal($totalDebtSum?:0, 2) ?> $</b></h4>
    </div>
