        ...
        <div class="table-responsive">
          ...
          <div class="modal-body hidden" id="toggleContent">
            <form id="qarztul" action="<?= Url::toRoute(['warehouse/qarztul'])?>" method="post">
              ...
              <input type="hidden" class="form-control" name="qarz_client_summ"/>
              <input type="hidden" class="form-control" name="tul_qarz_dollar_kurs" value="<?= $exchangeRate->dollar ?>"/>
              <div class="col-sm-8">
                <label class=" col-form-label"><h5><b>Sana</b></h5></label>
              ...
              <div class="col-sm-8">
                ...
                <span class="error_tul_qarz_sum_dollar text-danger"></span>
              </div>
              <div class="col-sm-8">
          ...
          <button id="sellButton" class="btn btn-sm btn-danger buy_product" style="width:100%" disabled>Kirim</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal-dialog2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Mahsulot qo'shish</h4></div>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger submit">Kirimga qo'shish</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal-dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Kirim</h4></div>
      <div class="modal-body">
        <form id="buy" action="<?= Url::toRoute(['warehouse/accept'])?>" method="post">
          ...
          <!-- <div class="form-group row m-b-15">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" class="form-control" name="summa_transfer"/>
          ...
          <div class="modal-footer">
            <a href="javascript:;" class="btn btn-white" data-dismiss="modal">Bekor qilish</a>
            <button type="submit" id="sellSubmitButton" class="btn btn-danger">Kirimni tasdiqlash</button>
          </div>
        </form>
      </div>
    </div>
...
//   if (isNaN(s4) || s4 < 0) { $(".error_summa_karta").text("To'langan summa kartada ni kiriting."); hasError = true; } else { $(".error_summa_karta").text(""); }
  ...
  $.ajax({
    ...
    $("#sellSubmitButton").prop("disabled", false).html('Kirimni tasdiqlash');
    $("#modal-dialog2").modal("hide");
  });
});
